...
def battle(board, player1, player2, iter, learn=False, show_result=True):
    ...
    if show_result:
        print("_" * 60)
        print(
            "{:>15}(X) | Wins:{}% Draws:{}% Losses:{}%".format(
                player1.__class__.__name__, p1_stats[1], p1_stats[0], p1_stats[2]
            ).center(50)
        )
        print(
            "{:>15}(O) | Wins:{}% Draws:{}% Losses:{}%".format(
                player2.__class__.__name__, p1_stats[2], p1_stats[0], p1_stats[1]
            ).center(50)
        )
        print("_" * 60)
        print()
